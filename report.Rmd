...
大纲    
1. Motivation   
  1.1 Overview of Project Goals and Motivation    
2. Related Work   
3. Initial Questions    
  3.1 Questions trying to answer    
  3.2 How did these questions evolve over the course of the project?    
  3.3 What new questions did you consider in the course of your analysis?   
4. Data   
  4.1 Data Sources    
  4.2 Scraping Method   
...
5. Exploratory Analysis   
  5.1 Visualizations    
  5.2 Summaries   
  5.3 Exploratory Statistical Analysis    
6. Additional Analysis    
  6.1 Formal Analysis   
7. Discussion   
  7.1 Findings/Expectations/Insights..    
</pre>
```
...
<pre>
留言板
1. 这三个数据集我感觉有很多不太需要的变量要不要精简一下？
2. Initial Quesitons这部分我好像不太好写因为需要“How did these questions evolve over the course of the project? What new questions did you consider in the course of your analysis?”但我不太了解你analysis过程遇到和解决了什么问题...感觉这个你来写更方便一点
</pre>
```
...
To visualize the coverage of retail stores by adding coverage zones based on store size. The geometry was transform the CRS to `EPSG:2263` for accurate distance-based calculations.Coverage zones were created around store locations using `st_buffer()`. The coverage radii were categorized into the following size groups:    
  ...
  - **Medium**: 0.25 miles (1,320 ft)   
  - **Large**: 0.35 miles (1,848 ft)   
>>>>>>> 7f75831cbcb8841c253a917d92ffa983a1f9ebe3
...
=======
Efforts could include incentivizing grocery stores to open in under-served areas, enhancing transportation options to food hubs, and supporting local farmers' markets to improve accessibility to nutritious food in food deserts. These actions could help bridge the food access gap and promote equitable food security across New York City.
>>>>>>> 7f75831cbcb8841c253a917d92ffa983a1f9ebe3
